...
+ (void)initialize
{
	if (self == [TWMessageView class])
	{
        ...
        // Colors
        kTWMessageViewTitleColor = [UIColor redColor];//[UIColor colorWithWhite:1.0 alpha:1.0];
...
+ (void)initialize
{
	...
	{
        // Colors (background)
        kTWDefaultMessageBarStyleSheetErrorBackgroundColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha: 0.6]; // orange
        ...
        // Colors (stroke)
        kTWDefaultMessageBarStyleSheetErrorStrokeColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha: 0.6];//[UIColor colorWithRed:0.949f green:0.580f blue:0.0f alpha:1.0f]; // orange
